...
class JangbuiController extends Controller
{
    ...
    public function index()
    {
		...
		return view( 'jangbui.index', $data );	// 자료 표시(view/product폴더의 index.blade.php)
    ...
    public function update(Request $request, $id)
    {
		...
		$row = Jangbu::find($id); 		// jangbui 모델변수 row 선언
		$this -> save_row($request, $row);		// 저장
	...
	public function save_row(Request $request, $row)
{
    ...
    [
		...
		$row->numi42 = $request->input("numi42");
		$row->numo42 = 0;
