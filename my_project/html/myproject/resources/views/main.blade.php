...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('mainimg.index')}}">
	...
	@endif
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="{{route('chart.index')}}">소대별 작전 할당 분포도</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">우수소대 / 출타자 확인:</h6>
                        <a class="collapse-item" href="{{route('best.index')}}">우수소대</a>
                        <a class="collapse-item" href="{{route('vacation.index')}}">병사 출타자 조회/등록</a>
						 <a class="collapse-item" href="{{route('officervacation.index')}}">간부 출타자 조회/등록</a>
<!--                 
				 <a class="collapse-item" href="{{route('mainimg.index')}}">부대 소개</a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('mainimg.index')}}">
