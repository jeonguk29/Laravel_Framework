...
class MemberController extends Controller
{
	...
	public function getlist($text1)
	{
		...
		$result = Member2::where('name42', 'like', '%' .$text1. '%')->orderby('name42','asc')->paginate(5)->appends(['text1' => $text1]);                            // Eloquent ORM
		// 필드이름 내번호 넣기 
    return $result;
	}
 ...
 /**
    ...
    $data['tmp'] = $this->qstring();   
     ...
     $data['row'] = Member2::find($id);     //find는 id만 검색할수있는 함수임   //Eloquent ORM
